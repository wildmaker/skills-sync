...
## Allowed commands
- `skills/harness-repo-init-docs-skeleton/scripts/init_harness_repo_docs_skeleton.sh`
...
2. 执行初始化脚本：
   `skills/harness-repo-init-docs-skeleton/scripts/init_harness_repo_docs_skeleton.sh <repo_path> --project "<project_name>"`
3. 检查输出：
   - 是否创建 `docs/` 结构化目录
