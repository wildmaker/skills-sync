---
name: skill-sync-repo-to-local
description: Sync local skills from the skill-sync spec repo. Use when pulling latest specs into local skills, creating missing skills or updating outdated ones.
---
