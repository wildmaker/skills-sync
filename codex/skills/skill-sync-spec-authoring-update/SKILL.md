---
name: skill-sync-spec-authoring-update
description: Create or update a spec in the single source of truth spec repo with enforced versioning and change semantics. Use when asked to create or update specs, bump versions, or append structured changelogs for any spec_id.
version: 0.0.0
---
