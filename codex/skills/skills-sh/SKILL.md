...
```bash
codex/skills/skills-sh/scripts/bootstrap_skills_sh.sh
```
...
```bash
codex/skills/skills-sh/scripts/bootstrap_skills_sh.sh <source> <agent>
```

Example:

```bash
codex/skills/skills-sh/scripts/bootstrap_skills_sh.sh vercel-labs/agent-skills codex
```
