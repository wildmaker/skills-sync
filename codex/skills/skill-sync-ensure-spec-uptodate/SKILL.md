---
name: skill-sync-ensure-spec-uptodate
description: Gatekeeper to verify a skill's referenced spec is up to date before executing the skill. Use when a skill needs to confirm spec version alignment, decide whether to sync, regenerate adapters, or block execution.
version: 0.0.0
---
