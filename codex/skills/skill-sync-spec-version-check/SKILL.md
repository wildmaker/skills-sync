---
name: skill-sync-spec-version-check
description: Read spec repo metadata to compare local spec version with latest version and return change_type and breaking info. Use as a pure version-check primitive for other skills.
version: 0.0.0
---
